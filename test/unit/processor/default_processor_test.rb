...
class DefaultProcessorTest < ActionDispatch::IntegrationTest
  ...
  def test_populated_resource_set_has_one_includes_relationships_are_resolved
    assert_equal 1003, $populated_resource_set_has_one_includes.resource_klasses[PostResource][10][:relationships][:author][:rids].first.id
    assert_equal 1004, $populated_resource_set_has_one_includes.resource_klasses[PostResource][12][:relationships][:author][:rids].first.id

    assert_equal 10, $populated_resource_set_has_one_includes.resource_klasses[PersonResource][1003][:relationships][:posts][:rids].first.id
    assert_equal 12, $populated_resource_set_has_one_includes.resource_klasses[PersonResource][1004][:relationships][:posts][:rids].first.id
  end
